<template>
  <div class="secondary">
    <Html lang="en">
      <Head>
        <Title>Harcorp Life LLC | Business Insurance</Title>
      </Head>
    </Html>
    ...
    <section>
      <div class="grid">
        ...
        <div class="col-12 lg:col-7 p-4 lg:px-8">
          <h3 class="mb-2">Types of Business Insurance</h3>
          <p class="mb-4">
    ...
    <section class="p-4">
      ...
      <p class="mb-4">
        Business owners can and should purchase general liability insurance to
        cover legal hassles due to accident, injuries and claims of negligence.
        These policies protect against payment due to the injured party as a
        result of bodily injury, property damage, medical expenses, libel,
        slander, the cost of defending lawsuits, and settlement bonds or
        judgments required during an appeal procedure. Ask an agent at Alliance
        West Insurance, Inc. about these coverages.
      </p>
      <h4 class="mb-2">Professional Liability Insurance</h4>
      <p>
        Business owners providing services should consider having professional
        liability insurance (also known as errors and omissions insurance). This
        type of liability coverage protects your business against malpractice,
        errors, and negligence in provision of services to your customers.
        Depending on your profession, you may be required by your state
        government to carry such a policy. For example, physicians are required
        to purchase malpractice insurance as a condition of practicing in
        certain states.
      </p>
    </section>
  </div>
